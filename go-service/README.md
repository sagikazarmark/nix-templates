# A Go service template

This template is suitable for Go service projects.
...
nix flake init --template github:sagikazarmark/nix-templates#go-service

# Create a new directory
nix flake new --template github:sagikazarmark/nix-templates#go-service NEW_PROJECT
```
